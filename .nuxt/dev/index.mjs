...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHost, getRequestProtocol, getQuery as getQuery$1, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, setHeader, getHeader, readBody, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, getResponseStatusText, H3Error } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/h3/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage, normalizeKey } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/unstorage/dist/index.mjs';
import lruCacheDriver from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/unstorage/drivers/lru-cache.mjs';
import { html as html$1 } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/satori-html/dist/index.js';
import { consola, createConsola } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/consola/dist/index.mjs';
import { createGenerator } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/@unocss/core/dist/index.mjs';
import presetWind from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/@unocss/preset-wind/dist/index.mjs';
import sizeOf from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/image-size/dist/index.js';
import playwrightCore from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/playwright-core/index.mjs';
import { Launcher } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/chrome-launcher/dist/index.js';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, parse, uneval } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/devalue/index.js';
import destr from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin, createHeadCore } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/unhead/dist/index.mjs';
import { toValue, version, unref } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/vue/index.mjs';
import { defineHeadPlugin } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/@unhead/shared/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/unstorage/drivers/fs.mjs';
import { klona } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/scule/dist/index.mjs';
import { $fetch as $fetch$1, createFetch as createFetch$1, Headers as Headers$1 } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/hookable/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/unctx/dist/index.mjs';
import devalue from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { defineNitroPlugin as defineNitroPlugin$1 } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/nitropack/dist/runtime/plugin.mjs';
import Fuse from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/fuse.js/dist/fuse.mjs';
import { resolve as resolve$1, isAbsolute } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/pathe/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import { diffLines } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/diff/lib/index.mjs';
import MagicString from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/magic-string/dist/magic-string.es.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/ipx/dist/index.mjs';
import { Resvg } from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/@resvg/resvg-js/index.js';
import _satori from 'file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/satori/dist/index.js';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    ...
    "nuxt-link-checker": {
      ...
      "rootDir": "E:/programing/prayer time v2 - Copy",
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "E:/programing/prayer time v2 - Copy/public"
      ]
    },
    "http": {
      "domains": []
...
const serverAssets = [{"baseName":"nuxt-og-image:fonts","dir":"E:/programing/prayer time v2 - Copy/.nuxt/cache/nuxt-og-image@3.0.0-rc.64/_fonts"},{"baseName":"server","dir":"E:/programing/prayer time v2 - Copy/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\programing\\prayer time v2 - Copy","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\programing\\prayer time v2 - Copy\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\programing\\prayer time v2 - Copy\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\programing\\prayer time v2 - Copy\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"E:\\programing\\prayer time v2 - Copy\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _fSySY11Md0 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "E:/programing/prayer time v2 - Copy";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _nSCm5hAPwm = (nitroApp) => {
...
const _s9ZpHNWbnc = defineNitroPlugin(async (nitroApp) => {
...
const _1jirBEDSSc = defineNitroPlugin(async (nitroApp) => {
...
const _jNrRPEWQYj = defineNitroPlugin$1(async (nitro) => {
  return;
});

const _IKyuuOvxmD = defineNitroPlugin$1((nitro) => {
  setTimeout(() => {
...
const _znC0sV = defineEventHandler(async (e) => {
...
const _2fHOxE = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _frreTE = defineEventHandler(async (e) => {
...
const _sj8C8Y = defineEventHandler(async (e) => {
...
const _GAZwG9 = defineEventHandler(async (e) => {
...
const _VyCXfI = defineEventHandler(async (e) => {
...
const _pJLkqu = defineEventHandler(async (e) => {
...
const _WDpN2P = defineEventHandler(async (e) => {
  const path = parseURL(e.path).pathname;
...
const _cC6bYX = defineEventHandler(async (e) => {
...
const _8uIxgr = defineEventHandler(async (e) => {
...
const _lQ2T5V = defineEventHandler(async (e) => {
  const runtimeConfig = useSimpleSitemapRuntimeConfig();
  const { sitemaps } = runtimeConfig;
...
const _TSGmYU = defineEventHandler(async (e) => {
...
const _3gPfCR = defineEventHandler(async (e) => {
  const path = parseURL(e.path).pathname;
  if (fileMapping[path]) {
...
const _voSMcl = defineEventHandler(async (e) => {
...
const _mmrS1o = defineEventHandler(async () => {
  const runtimeConfig = useRuntimeConfig().public["nuxt-link-checker"];
  const linkDb = [
    ...pagePaths
  ];
...
const _Kk1W4k = defineEventHandler(async (e) => {
  return {
    runtimeConfig: useRuntimeConfig(e).public["nuxt-link-checker"]
  };
});

const _39o96X = lazyEventHandler(() => {
...
const _lazy_WQ58fo = () => Promise.resolve().then(function () { return renderer$1; });
const _lazy_eMLdIZ = () => Promise.resolve().then(function () { return font$1; });
const _lazy_KfMoqK = () => Promise.resolve().then(function () { return debug_json$1; });
const _lazy_XV4rEe = () => Promise.resolve().then(function () { return image$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_WQ58fo, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _znC0sV, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _2fHOxE, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _frreTE, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _sj8C8Y, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug.json', handler: _GAZwG9, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-path.json', handler: _VyCXfI, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap_index.xml', handler: _pJLkqu, lazy: false, middleware: false, method: undefined },
  { route: '/en-US-sitemap.xml', handler: _WDpN2P, lazy: false, middleware: false, method: undefined },
  { route: '/ar-sitemap.xml', handler: _WDpN2P, lazy: false, middleware: false, method: undefined },
  { route: '/fr-sitemap.xml', handler: _WDpN2P, lazy: false, middleware: false, method: undefined },
  { route: '/id-sitemap.xml', handler: _WDpN2P, lazy: false, middleware: false, method: undefined },
  { route: '/tr-sitemap.xml', handler: _WDpN2P, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _cC6bYX, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _8uIxgr, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _lQ2T5V, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_eMLdIZ, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/debug.json', handler: _lazy_KfMoqK, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_XV4rEe, lazy: true, middleware: false, method: undefined },
  { route: '/__schema-org__/debug.json', handler: _TSGmYU, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _3gPfCR, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/inspect', handler: _voSMcl, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/links', handler: _mmrS1o, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/debug.json', handler: _Kk1W4k, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _39o96X, lazy: false, middleware: false, method: undefined },
  { route: '/', handler: _lazy_WQ58fo, lazy: true, middleware: false, method: undefined },
  { route: '/app/quran', handler: _lazy_WQ58fo, lazy: true, middleware: false, method: undefined },
  { route: '/sitemap.xsl', handler: _lazy_WQ58fo, lazy: true, middleware: false, method: undefined },
  { route: '/index-sitemap.xml', handler: _lazy_WQ58fo, lazy: true, middleware: false, method: undefined },
  { route: '/_nuxt/builds/meta/**', handler: _lazy_WQ58fo, lazy: true, middleware: false, method: undefined },
  { route: '/_nuxt/builds/**', handler: _lazy_WQ58fo, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_WQ58fo, lazy: true, middleware: false, method: undefined }
];
...
async function useSharp() {
  sharpInstance.instance = sharpInstance.instance || await import('file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/unenv/runtime/mock/empty.mjs').then((m) => m.default);
  return sharpInstance.instance;
}
async function useCssInline() {
  cssInlineInstance.instance = cssInlineInstance.instance || await import('file://E:/programing/prayer%20time%20v2%20-%20Copy/node_modules/unenv/runtime/mock/empty.mjs').then((m) => m.default);
...
const appHead = {"link":[{"rel":"icon","type":"image/x-icon","href":"/logo.png"}],"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"property":"og:type","content":"website"}],"style":[],"script":[],"noscript":[],"charset":"utf-8","viewport":"width=device-width, initial-scale=1","htmlAttrs":{}};
...
const getClientManifest = () => import('file://E:/programing/prayer%20time%20v2%20-%20Copy/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://E:/programing/prayer%20time%20v2%20-%20Copy/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const componentNames = [{"hash":"i0Vxmj8bqg","pascalName":"BrandedLogo","kebabName":"branded-logo","path":"E:/programing/prayer time v2 - Copy/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/BrandedLogo.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"tBHg51xiAt","pascalName":"Frame","kebabName":"frame","path":"E:/programing/prayer time v2 - Copy/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/Frame.vue","category":"community","credits":"@arashsheyda <https://github.com/arashsheyda>"},{"hash":"Sqc3OTP2KQ","pascalName":"Nuxt","kebabName":"nuxt","path":"E:/programing/prayer time v2 - Copy/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/Nuxt.vue","category":"community","credits":"NuxtLabs <https://nuxtlabs.com/>"},{"hash":"NEgliLpoqF","pascalName":"NuxtSeo","kebabName":"nuxt-seo","path":"E:/programing/prayer time v2 - Copy/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/NuxtSeo.vue","category":"community","credits":"Nuxt SEO <https://nuxtseo.com/>"},{"hash":"q432NYEB0T","pascalName":"Pergel","kebabName":"pergel","path":"E:/programing/prayer time v2 - Copy/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/Pergel.vue","category":"community","credits":"Pergel <https://nuxtlabs.com/>"},{"hash":"YDrRRvPRVl","pascalName":"SimpleBlog","kebabName":"simple-blog","path":"E:/programing/prayer time v2 - Copy/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/SimpleBlog.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"wt558K6QyQ","pascalName":"UnJs","kebabName":"un-js","path":"E:/programing/prayer time v2 - Copy/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/UnJs.vue","category":"community","credits":"UnJS <https://unjs.io/>"},{"hash":"6RdQZcuwZZ","pascalName":"Wave","kebabName":"wave","path":"E:/programing/prayer time v2 - Copy/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/Wave.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"gaB1TrbtTl","pascalName":"WithEmoji","kebabName":"with-emoji","path":"E:/programing/prayer time v2 - Copy/node_modules/nuxt-og-image/dist/runtime/nuxt/components/Templates/Community/WithEmoji.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"}];
